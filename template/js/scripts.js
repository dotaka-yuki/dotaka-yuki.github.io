...
window.addEventListener('DOMContentLoaded', () => {
    const translations = {
        ...
        ja: {
            ...
            'brand.name': 'Clarence Taylor',
            'brand.profileAlt': 'Clarence Taylor のプロフィール写真',
            ...
            'about.lastName': 'Taylor',
            'about.contact': '3542 Berry Street · Cheyenne Wells, CO 80810 · (317) 585-8468 · <a href="mailto:name@email.com">name@email.com</a>',
            'about.lead': 'アジャイルな枠組みを活用して、高レベルの概要をまとめることを得意としています。反復的な企業戦略の進め方により、全体の価値提案に向けた協働的な発想を促します。',
            ...
            'awards.item1': 'Google Analytics 認定デベロッパー',
            'awards.item2': 'モバイル Web スペシャリスト - Google 認定',
            'awards.item3': '1 <sup>st</sup> 位 - コロラド大学ボルダー校 - Emerging Tech Competition 2009',
            'awards.item4': '1 <sup>st</sup> 位 - コロラド大学ボルダー校 - Adobe Creative Jam 2008 (UI Design Category)',
            'awards.item5': '2 <sup>nd</sup> 位 - コロラド大学ボルダー校 - Emerging Tech Competition 2008',
            'awards.item6': '1 <sup>st</sup> 位 - James Buchanan High School - Hackathon 2006',
            'awards.item7': '3 <sup>rd</sup> 位 - James Buchanan High School - Hackathon 2005',
        },
    };
